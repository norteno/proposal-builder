      ...
      <div className="proposal-preview-shell w-full overflow-hidden" style={themeVars}>
        ...
        <section className="bg-[var(--cream)]" style={{ color: proposal.sectionTextColors.about }}>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[520px_1fr]">
            ...
            <div><p className="text-xs uppercase tracking-[0.22em] opacity-100">About the studio</p><h2 className="mt-4 max-w-lg font-display text-4xl font-black leading-none tracking-[-0.02em] sm:text-5xl" style="margin-top: 30px">{proposal.aboutTitle}</h2><p className="mt-8 max-w-3xl text-lg leading-8" style={{ color: proposal.sectionBodyColors.about }}>{proposal.aboutBody}</p></div>
          </div>
