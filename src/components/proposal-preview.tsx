      ...
      <div className="proposal-preview-shell w-full overflow-hidden" style={themeVars}>
        <section className="relative min-h-[680px] bg-[var(--primary)]" style={{ color: proposal.sectionTextColors.hero }}>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="mt-44 max-w-[51rem]">
            ...
            <div className="mt-10 grid gap-6 border-t border-[#061D00]/40 pt-6 text-sm sm:grid-cols-[1fr_220px]" style={{ color: proposal.sectionBodyColors.hero }}>
              <p>{proposal.introLetter}</p><div className="border-l border-[#061D00]/40 pl-5"><p className="uppercase tracking-[0.18em]">Prepared By</p><p className="mt-2" style={{ color: proposal.sectionTextColors.hero }}>The Graphic Standard</p></div>
            </div>
          </motion.div>
          </SectionInner>
        </section>
