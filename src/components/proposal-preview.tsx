      ...
      <div className="proposal-preview-shell w-full overflow-hidden" style={themeVars}>
        ...
        <section className="bg-[var(--cream)]" style={{ color: proposal.sectionTextColors.about }}>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[320px_1fr]">
            {proposal.aboutImageUrl ? <div className="overflow-hidden rounded-[2rem] shadow-xl"><ImageOrPlaceholder src={proposal.aboutImageUrl} label="About the studio" className="aspect-[5/4] w-full bg-neutral-800/80 object-cover" /></div> : <div className="flex gap-3">{[0, 1, 2].map((item) => <div key={item} className="h-32 w-24 rounded-t-full bg-neutral-800/80" />)}</div>}
