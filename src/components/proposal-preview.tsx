  ...
  return (
    <div role="main" className={clean ? "min-h-screen bg-neutral-200" : "flex-1 overflow-y-auto bg-neutral-200"}>
      <div className="proposal-preview-shell w-full overflow-hidden" style={themeVars}>
        ...
        <section className="bg-[var(--primary)]" style={{ color: proposal.sectionTextColors.handoff }}><SectionInner className="min-h-[120px] py-12" contentClassName="flex min-h-[120px] items-end justify-center text-center"><h2 className="mt-6 max-w-xl text-lg leading-8">Thank you for considering TGS. Contact: Shane Bzdok shane@thegraphicstandard.com 512.761.0367</h2></SectionInner></section>
      </div>
    </div>
  );
}
